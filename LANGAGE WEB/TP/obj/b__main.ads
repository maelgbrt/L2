...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#30495148#;
   ...
   u00006 : constant Version_32 := 16#ba03ad8f#;
   pragma Export (C, u00006, "ada__characters__handlingB");
   u00007 : constant Version_32 := 16#21df700b#;
   ...
   u00012 : constant Version_32 := 16#3cc6bdbe#;
   ...
   u00014 : constant Version_32 := 16#63b0b7fe#;
   pragma Export (C, u00014, "system__soft_linksS");
   u00015 : constant Version_32 := 16#e10050ae#;
   ...
   u00023 : constant Version_32 := 16#59a6462e#;
   ...
   u00025 : constant Version_32 := 16#1fe22d38#;
   ...
   u00028 : constant Version_32 := 16#02391b10#;
   pragma Export (C, u00028, "system__storage_elementsS");
   u00029 : constant Version_32 := 16#01838199#;
   pragma Export (C, u00029, "system__tracebackB");
   u00030 : constant Version_32 := 16#6f77a74f#;
   pragma Export (C, u00030, "system__tracebackS");
   u00031 : constant Version_32 := 16#1f08c83e#;
   pragma Export (C, u00031, "system__traceback_entriesB");
   u00032 : constant Version_32 := 16#09528275#;
   pragma Export (C, u00032, "system__traceback_entriesS");
   u00033 : constant Version_32 := 16#8dd2b87e#;
   pragma Export (C, u00033, "system__traceback__symbolicB");
   u00034 : constant Version_32 := 16#4f57b9be#;
   ...
   u00037 : constant Version_32 := 16#bba159a5#;
   ...
   u00040 : constant Version_32 := 16#66134eae#;
   pragma Export (C, u00040, "system__crtlS");
   u00041 : constant Version_32 := 16#896564a3#;
   pragma Export (C, u00041, "system__parametersB");
   u00042 : constant Version_32 := 16#68a895df#;
   pragma Export (C, u00042, "system__parametersS");
   u00043 : constant Version_32 := 16#13176495#;
   pragma Export (C, u00043, "system__dwarf_linesB");
   u00044 : constant Version_32 := 16#881894a3#;
   ...
   u00048 : constant Version_32 := 16#58ecb7ed#;
   pragma Export (C, u00048, "system__img_unsS");
   u00049 : constant Version_32 := 16#04fd2587#;
   ...
   u00057 : constant Version_32 := 16#c7b29a75#;
   pragma Export (C, u00057, "system__os_libB");
   u00058 : constant Version_32 := 16#1c53dcbe#;
   pragma Export (C, u00058, "system__os_libS");
   u00059 : constant Version_32 := 16#ec4d5631#;
   pragma Export (C, u00059, "system__case_utilB");
   u00060 : constant Version_32 := 16#102fe740#;
   pragma Export (C, u00060, "system__case_utilS");
   u00061 : constant Version_32 := 16#2a8e89ad#;
   pragma Export (C, u00061, "system__stringsB");
   u00062 : constant Version_32 := 16#63b7b2c6#;
   pragma Export (C, u00062, "system__stringsS");
   u00063 : constant Version_32 := 16#fb01eaa4#;
   pragma Export (C, u00063, "interfaces__cB");
   u00064 : constant Version_32 := 16#7300324d#;
   pragma Export (C, u00064, "interfaces__cS");
   u00065 : constant Version_32 := 16#a2bb689b#;
   pragma Export (C, u00065, "system__object_readerB");
   u00066 : constant Version_32 := 16#7d8b329a#;
   pragma Export (C, u00066, "system__object_readerS");
   u00067 : constant Version_32 := 16#f21a80dd#;
   pragma Export (C, u00067, "system__val_lliS");
   u00068 : constant Version_32 := 16#197f7a7d#;
   pragma Export (C, u00068, "system__val_lluS");
   u00069 : constant Version_32 := 16#879d81a3#;
   pragma Export (C, u00069, "system__val_utilB");
   u00070 : constant Version_32 := 16#835ae7ea#;
   pragma Export (C, u00070, "system__val_utilS");
   u00071 : constant Version_32 := 16#992dbac1#;
   pragma Export (C, u00071, "system__exception_tracesB");
   u00072 : constant Version_32 := 16#2dd6549f#;
   pragma Export (C, u00072, "system__exception_tracesS");
   u00073 : constant Version_32 := 16#e3e8dc36#;
   pragma Export (C, u00073, "system__win32S");
   u00074 : constant Version_32 := 16#8c33a517#;
   pragma Export (C, u00074, "system__wch_conB");
   u00075 : constant Version_32 := 16#348773c6#;
   pragma Export (C, u00075, "system__wch_conS");
   u00076 : constant Version_32 := 16#9721e840#;
   pragma Export (C, u00076, "system__wch_stwB");
   u00077 : constant Version_32 := 16#19965fc7#;
   pragma Export (C, u00077, "system__wch_stwS");
   u00078 : constant Version_32 := 16#1f681dab#;
   pragma Export (C, u00078, "system__wch_cnvB");
   u00079 : constant Version_32 := 16#3b30c935#;
   pragma Export (C, u00079, "system__wch_cnvS");
   u00080 : constant Version_32 := 16#ece6fdb6#;
   pragma Export (C, u00080, "system__wch_jisB");
   u00081 : constant Version_32 := 16#bb40d014#;
   pragma Export (C, u00081, "system__wch_jisS");
   u00082 : constant Version_32 := 16#ce3e0e21#;
   pragma Export (C, u00082, "system__soft_links__initializeB");
   u00083 : constant Version_32 := 16#5697fc2b#;
   pragma Export (C, u00083, "system__soft_links__initializeS");
   u00084 : constant Version_32 := 16#41837d1e#;
   pragma Export (C, u00084, "system__stack_checkingB");
   u00085 : constant Version_32 := 16#a1453afc#;
   pragma Export (C, u00085, "system__stack_checkingS");
   u00086 : constant Version_32 := 16#24ece25f#;
   pragma Export (C, u00086, "ada__strings__mapsB");
   u00087 : constant Version_32 := 16#ac61938c#;
   pragma Export (C, u00087, "ada__strings__mapsS");
   u00088 : constant Version_32 := 16#1db72f30#;
   pragma Export (C, u00088, "system__bit_opsB");
   u00089 : constant Version_32 := 16#0765e3a3#;
   pragma Export (C, u00089, "system__bit_opsS");
   u00090 : constant Version_32 := 16#20c3a773#;
   pragma Export (C, u00090, "ada__strings__maps__constantsS");
