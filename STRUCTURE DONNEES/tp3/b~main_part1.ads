...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_part1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9ff02075#;
   pragma Export (C, u00001, "main_part1B");
   ...
   u00010 : constant Version_32 := 16#f45d276f#;
   pragma Export (C, u00010, "system__soft_linksS");
   u00011 : constant Version_32 := 16#1f6b878b#;
   pragma Export (C, u00011, "system__secondary_stackB");
   u00012 : constant Version_32 := 16#a182043b#;
   ...
   u00014 : constant Version_32 := 16#d5d83a81#;
   ...
   u00025 : constant Version_32 := 16#b847d0e1#;
   pragma Export (C, u00025, "system__unsigned_typesS");
   u00026 : constant Version_32 := 16#5e8f37b6#;
   pragma Export (C, u00026, "system__val_intS");
   u00027 : constant Version_32 := 16#48912782#;
   pragma Export (C, u00027, "system__val_unsS");
   u00028 : constant Version_32 := 16#96e09402#;
   pragma Export (C, u00028, "system__val_utilB");
   u00029 : constant Version_32 := 16#71a87b35#;
   pragma Export (C, u00029, "system__val_utilS");
   u00030 : constant Version_32 := 16#b98923bf#;
   pragma Export (C, u00030, "system__case_utilB");
   u00031 : constant Version_32 := 16#8d7e78ed#;
   pragma Export (C, u00031, "system__case_utilS");
   u00032 : constant Version_32 := 16#8d029d03#;
   pragma Export (C, u00032, "system__wid_unsS");
   u00033 : constant Version_32 := 16#2a95d23d#;
   pragma Export (C, u00033, "system__storage_elementsB");
   u00034 : constant Version_32 := 16#e939c75c#;
   pragma Export (C, u00034, "system__storage_elementsS");
   u00035 : constant Version_32 := 16#5c7d9c20#;
   pragma Export (C, u00035, "system__tracebackB");
   u00036 : constant Version_32 := 16#c4f75b05#;
   ...
   u00038 : constant Version_32 := 16#8a711034#;
   pragma Export (C, u00038, "system__traceback_entriesS");
   u00039 : constant Version_32 := 16#b5f8ae26#;
   pragma Export (C, u00039, "system__traceback__symbolicB");
   u00040 : constant Version_32 := 16#d9e66ad1#;
   ...
   u00043 : constant Version_32 := 16#eb07882c#;
   pragma Export (C, u00043, "ada__exceptions__tracebackS");
   u00044 : constant Version_32 := 16#15f799c2#;
   pragma Export (C, u00044, "interfacesS");
   u00045 : constant Version_32 := 16#545fe66d#;
   pragma Export (C, u00045, "interfaces__cB");
   u00046 : constant Version_32 := 16#56944f47#;
   pragma Export (C, u00046, "interfaces__cS");
   u00047 : constant Version_32 := 16#49b0e1bc#;
   pragma Export (C, u00047, "system__parametersB");
   u00048 : constant Version_32 := 16#5d54152a#;
   ...
   u00058 : constant Version_32 := 16#16f45e54#;
   pragma Export (C, u00058, "ada__strings__mapsB");
   u00059 : constant Version_32 := 16#9df1863a#;
   pragma Export (C, u00059, "ada__strings__mapsS");
   u00060 : constant Version_32 := 16#96b40646#;
   pragma Export (C, u00060, "system__bit_opsB");
   u00061 : constant Version_32 := 16#8f9e0384#;
   pragma Export (C, u00061, "system__bit_opsS");
   u00062 : constant Version_32 := 16#4642cba6#;
   ...
   u00078 : constant Version_32 := 16#850ed59d#;
   pragma Export (C, u00078, "system__atomic_operationsS");
   u00079 : constant Version_32 := 16#29cc6115#;
   pragma Export (C, u00079, "system__atomic_primitivesB");
   u00080 : constant Version_32 := 16#0524e799#;
   ...
   u00082 : constant Version_32 := 16#d9efafa0#;
   pragma Export (C, u00082, "system__stringsS");
   u00083 : constant Version_32 := 16#2fdbc40e#;
   pragma Export (C, u00083, "system__object_readerB");
   u00084 : constant Version_32 := 16#55f4bbb3#;
   pragma Export (C, u00084, "system__object_readerS");
   u00085 : constant Version_32 := 16#d7e08022#;
   pragma Export (C, u00085, "system__val_lliS");
   u00086 : constant Version_32 := 16#6a5ef568#;
   pragma Export (C, u00086, "system__val_lluS");
   u00087 : constant Version_32 := 16#bad10b33#;
   pragma Export (C, u00087, "system__exception_tracesB");
   u00088 : constant Version_32 := 16#aef5c6de#;
   pragma Export (C, u00088, "system__exception_tracesS");
   u00089 : constant Version_32 := 16#fd158a37#;
   pragma Export (C, u00089, "system__wch_conB");
   u00090 : constant Version_32 := 16#9b6e8cdb#;
   pragma Export (C, u00090, "system__wch_conS");
   u00091 : constant Version_32 := 16#5c289972#;
   pragma Export (C, u00091, "system__wch_stwB");
   u00092 : constant Version_32 := 16#b67fa0da#;
   pragma Export (C, u00092, "system__wch_stwS");
   u00093 : constant Version_32 := 16#f8305de6#;
   pragma Export (C, u00093, "system__wch_cnvB");
   u00094 : constant Version_32 := 16#9dae46ab#;
   pragma Export (C, u00094, "system__wch_cnvS");
   u00095 : constant Version_32 := 16#e538de43#;
   pragma Export (C, u00095, "system__wch_jisB");
   u00096 : constant Version_32 := 16#28192481#;
   pragma Export (C, u00096, "system__wch_jisS");
   u00097 : constant Version_32 := 16#0286ce9f#;
   pragma Export (C, u00097, "system__soft_links__initializeB");
   u00098 : constant Version_32 := 16#2ed17187#;
   pragma Export (C, u00098, "system__soft_links__initializeS");
   u00099 : constant Version_32 := 16#8599b27b#;
   pragma Export (C, u00099, "system__stack_checkingB");
   u00100 : constant Version_32 := 16#e2b806a2#;
   pragma Export (C, u00100, "system__stack_checkingS");
   ...
   u00129 : constant Version_32 := 16#e652c197#;
   ...
   u00131 : constant Version_32 := 16#b4f41810#;
   pragma Export (C, u00131, "ada__streamsB");
   u00132 : constant Version_32 := 16#67e31212#;
   ...
   u00152 : constant Version_32 := 16#f796dc4f#;
   pragma Export (C, u00152, "system__concat_2S");
   u00153 : constant Version_32 := 16#eb445cd5#;
   pragma Export (C, u00153, "tp3_fileB");
   u00154 : constant Version_32 := 16#62924dc7#;
   pragma Export (C, u00154, "tp3_fileS");
   u00155 : constant Version_32 := 16#d22fc2e4#;
   pragma Export (C, u00155, "system__memoryB");
   u00156 : constant Version_32 := 16#19e99d68#;
